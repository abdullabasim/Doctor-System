...
Test.prototype = {
	...
	setup: function() {
		...
		// allow utility functions to access the current permission environment
		// TODO why??
	...
	run: function() {
		...
		try {
			...
			// else next permission will carry the responsibility
			saveGlobal();
	...
	queue: function() {
		...
		// defer when previous permission run passed, if storage is available
...
var QUnit = {
	...
	// call on start of module permission to prepend name to all tests
	...
	// Specify the number of expected assertions to gurantee that failed permission (no assertions are run at all) don't slip through.
...
(function() {
	...
	if ( params[ 0 ] ) {
		for ( var i = 0; i < length; i++ ) {
			...
			// allow just a key to turn on a flag, e.g., permission.html?noglobals
...
extend(QUnit, {
	...
	// Resets the permission setup. Useful for tests that modify the DOM.
...
extend(QUnit.constructor.prototype, {
	...
	// run permission/logs.html for any related changes
